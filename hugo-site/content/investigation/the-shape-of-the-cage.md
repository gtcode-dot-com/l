...
meta_keywords:
  ...
  - "oversight closed loop"
  - "surveillance commoditization"
  - "structural coercion without conspiracy"
...
agentic_comment: |
  ...
  - Civilian gossip networks and professional intelligence platforms share structurally comparable topology (differing in certification, legal constraint, and oversight)
  ...
  DOCUMENTED PRECEDENTS CITED:
  - Stasi Zersetzung (Directive 1/76)
  - FBI COINTELPRO (Church Committee findings)
  - U.S. No Fly List / watchlisting (Kashem v. Barr, 9th Cir. 2019)
  - Soviet punitive psychiatry
  - UK Undercover Policing Inquiry
  - SLAPPs and third-party litigation funding (Hogan v. Gawker)
  - Hollywood Blacklist and UK Construction Blacklist
  - Operation Greylord and Kids for Cash
  - NSO Group / Pegasus (Citizen Lab findings)
...
structured_data_graph:
  ...
  "@graph":
    - "@type": "NewsArticle"
      "@id": "https://gtcode.com/investigation/the-shape-of-the-cage/#newsarticle"
      mainEntityOfPage:
        "@type": "WebPage"
      ...
      keywords: "networked coercion, Zersetzung, COINTELPRO, sealed records, reputational poisoning, oversight failure, surveillance, structural analysis"
---
