...
date: '2026-04-02T02:44:59.984849+00:00'
exported_at: '2026-04-02T02:45:02.254587+00:00'
...
structured_data:
  about: []
  author: ''
  description: ‘CanisterWorm’ Springs Wiper Attack Targeting Iran
  headline: ‘CanisterWorm’ Springs Wiper Attack Targeting Iran
  inLanguage: en
  keywords: []
  main_image: ''
  original_source: https://krebsonsecurity.com/2026/03/canisterworm-springs-wiper-attack-targeting-iran
  publisher:
    logo: /favicon.ico
    name: GTCode
title: ‘CanisterWorm’ Springs Wiper Attack Targeting Iran
updated_at: '2026-04-02T02:44:59.984849+00:00'
url_hash: 6fae97d25c89251341a641b4267f2ded82895104
---
...
**Assaf Morag**
[wrote](https://flare.io/learn/resources/blog/teampcp-cloud-native-ransomware)
...
[removed](https://github.com/aquasecurity/trivy/discussions/10425)
the harmful files, but the security firm Wiz
[notes](https://www.wiz.io/blog/trivy-compromised-teampcp-supply-chain-attack)
...
**Aikido**
. In
[a blog post](https://www.aikido.dev/blog/teampcp-stage-payload-canisterworm-iran)
...
[Internet Computer Protocol](https://docs.internetcomputer.org/building-apps/essentials/canisters)
...
[GitHub is Starting to Have a Real Malware Problem](https://risky.biz/risky-bulletin-github-is-starting-to-have-a-real-malware-problem/)
,
**Risky Business**
reporter
**Catalin Cimpanu**
...
[second major supply chain attack](https://ramimac.me/trivy-teampcp/)
involving Trivy in as many months. At the end of February, Trivy was hit as part of an automated threat called
[HackerBot-Claw](https://www.stepsecurity.io/blog/hackerbot-claw-github-actions-exploitation#attack-3-microsoftai-discovery-agent---branch-name-injection)
...
[a Rick Roll video](https://www.youtube.com/watch?v=dQw4w9WgXcQ)
on YouTube.
...
**Update, 2:40 p.m. ET:**
Wiz is
[reporting](https://www.wiz.io/blog/teampcp-attack-kics-github-action)
