...
structured_data:
  about: []
  author: ''
  description: Peru has increased its squid catch limit. The article says “giant squid,”
    but they can’t possibly mean that. As usual, you can also use this squid post
    to talk about the security stories in the news that I haven’t covered. Blog moderation
    policy.
  headline: 'Friday Squid Blogging: Squid Fishing in Peru'
  inLanguage: en
  keywords: []
  main_image: ''
  original_source: https://www.schneier.com/blog/archives/2026/02/friday-squid-blogging-squid-fishing-in-peru.html
  publisher:
    logo: /favicon.ico
    name: GTCode
...
Peru has
[increased](https://www.bairdmaritime.com/fishing/regulation-enforcement/peru-updates-giant-squid-catch-limit-for-artisanal-fishing)
its squid catch limit. The article says “giant squid,” but they can’t possibly mean that.
