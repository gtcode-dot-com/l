...
structured_data:
  about: []
  author: ''
  description: 'This is a very weird story about how squid stayed on the menu of Byzantine
    monks by falling between the cracks of dietary rules. At Constantinople’s Monastery
    of Stoudios, the kitchen didn’t answer to appetite. It answered to the “typikon”:
    a manual for ensuring that nothing unexpected happened at mealtimes. Meat: f...'
  headline: 'Friday Squid Blogging: Squid in Byzantine Monk Cooking'
  inLanguage: en
  keywords: []
  main_image: ''
  original_source: https://www.schneier.com/blog/archives/2026/03/friday-squid-blogging-squid-in-byzantine-monk-cooking.html
  publisher:
    logo: /favicon.ico
    name: GTCode
...
[story](https://www.turkiyetoday.com/lifestyle/how-stuffed-squid-survived-byzantine-monks-and-ottoman-tables-by-staying-ink-ognito-3215117?s=1)
about how squid stayed on the menu of Byzantine monks by falling between the cracks of dietary rules.
...
Tags:
[squid](https://www.schneier.com/tag/squid/)
