...
structured_data:
  about: []
  author: ''
  description: Tech site Data Center Dynamics (DCD) has seen its traffic and turnover
    increase year on year following an AI boom and Covid.
  headline: The technology news website hiring not firing with £11m turnover
  inLanguage: en
  keywords: []
  main_image: ''
...
has seen its turnover increase by 175% to more than £11m a year since 2020 helped by the
...
In the year ending December 2024, turnover for Data Center Dynamics Ltd reached £11.2m, up from £8.8m in 2023,
[according to Companies House filings](https://find-and-update.company-information.service.gov.uk/company/06799556/filing-history)
. Adjusted EBITDA stood at £2.2m.
...
The site’s growth follows extensive cutbacks in the world of technology journalism in 2025:
[in June, Techcrunch made the decision to pull out of the UK and Europe](https://pressgazette.co.uk/publishers/digital-journalism/around-ten-staff-axed-in-techcrunch-move-to-scrap-europe-coverage/)
, followed by 19 staff cut at tech news and reviews site CNET in July.
...
Many publishers are seeing AI answer engines cite their content and prevent clickthroughs, but DCD finds its traffic from
[ChatGPT](https://pressgazette.co.uk/subject/chatgpt/)
has increased when the chatbot cites its site.

While
[celebrity and showbiz queries are most likely to trigger AI Overviews for titles like the Daily Mail](https://pressgazette.co.uk/publishers/search-isnt-dead-its-fragmenting-how-to-manage-google-traffic-decline/)
, internet infrastructure experts are not going to “want to risk that something is hallucinated” – potentially protecting it from
[“Google zero”](https://pressgazette.co.uk/publishers/magazines/future-takes-action-on-google-zero-as-revenue-declines/)
.
...
With feature-styles pieces, Moss said DCD tries “make a physical aspect to it”, for example basing pieces around site visits, as to protect it from chatbot-like replication –
[DCD once sent a feature to the moon](https://www.datacenterdynamics.com/en/analysis/how-this-feature-got-to-the-moon/)
, with a SpaceX rocket carrying the piece on a drive when it launched.
...
![DCD editor-in-chief Sebastian Moss with a rocket background. Picture: Sebastian Moss](https://pressgazette.co.uk/wp-content/uploads/sites/7/2026/02/dcd1sebmoss-800x600.jpg)
...
DCD also plans to hire an investment reporter, confident sector growth will continue in the wake of
[OpenAI’s $1.4trn spend in data centre commitments over next five to six years](https://techcrunch.com/2025/11/06/sam-altman-says-openai-has-20b-arr-and-about-1-4-trillion-in-data-center-commitments/)
