...
structured_data:
  about: []
  author: ''
  description: Malawi’s government has promised a “fact-finding exercise” as the local
    community grows increasingly resentful of the mining venture’s unfulfilled development
    promises.
  headline: Investigation reveals how Chinese firms blindsided Malawian government
    over strategic mine ownership
  inLanguage: en
  keywords: []
  main_image: ''
...
The
[probe](https://www.pijmalawi.org/show-story/the-chinese-mining-takeover)
