...
date: '2026-06-02T00:25:18.542690+00:00'
exported_at: '2026-06-02T00:25:20.821100+00:00'
...
structured_data:
  about: []
  author: ''
  description: Featured at the International Conference on Robotics and Automation,
    eight new NVIDIA Research papers show how robots trained in simulation are moving
    into the real world.
  headline: NVIDIA Research Advances Robotics From Simulation to the Real World
  inLanguage: en
  keywords: []
  main_image: ''
  original_source: https://blogs.nvidia.com/blog/icra-research-robotics-simulation-to-real-world
  publisher:
    logo: /favicon.ico
    name: GTCode
title: NVIDIA Research Advances Robotics From Simulation to the Real World
updated_at: '2026-06-02T00:25:18.542690+00:00'
url_hash: e89958f9e5c855a2ef262d003003464fbcdf4534
---
...
At the
[International Conference on Robotics and Automation (ICRA)](https://www.nvidia.com/en-us/events/icra/)

, eight of NVIDIA Research’s 28 accepted papers show how simulation-to-real transfer is becoming a foundation for that shift, helping robots perceive, reason, plan and act across dynamic, unpredictable environments.
...
changes that by running computations on GPUs, letting multiple arms plan movements and operate in parallel. The result — a 3x speedup across multi-arm planning scenarios, on hardware like the
[NVIDIA Jetson](https://www.nvidia.com/en-us/autonomous-machines/embedded-systems/)

edge AI platform. Code for the framework is available on
[GitHub](https://github.com/NVlabs/ScheduleStream)
...
policy framework solves this by first building the baseline navigation functionality using imitation learning and then using residual
...
to build specialists for diverse robot embodiments. Crucially, no real-world robot data is involved at any stage: everything is trained in Isaac Lab simulation.
...
COMPASS is
[agent-friendly](https://github.com/NVlabs/COMPASS/tree/main/.claude/skills)

, with dedicated skills — and developers can connect the pipeline with
[NVIDIA Omniverse NuRec](https://developer.nvidia.com/omniverse/nurec)

to post-train and validate robots in a
[digital twin](https://www.nvidia.com/en-us/glossary/digital-twin/)

of a novel environment before deployment.
...
adaptively computes robotic grasps, continuously correcting the robot’s motion as it closes in on the object, rather than carrying out a fixed plan — the way a person grabs something by feeling rather than calculating every joint angle in advance.

To build the policy, the researchers generated 2 million simulated trajectories across 8,000 objects using annotations from the
[GraspGen](https://github.com/NVlabs/GraspGen)

dataset and motion planning data from
[cuRobo](https://github.com/nvlabs/curobo)

, a CUDA-accelerated library for robot motion generation.
...
introduces a framework that tackles a parallel challenge: enabling systems to grasp not just one object, but a whole bundle of flexible, tangled material at once.
...
The researchers built a tree generator using biological growth equations to create synthetic trees of many different shapes and sizes — then trained the system across thousands of them in
...
![](https://blogs.nvidia.com/wp-content/uploads/2026/05/Cluster-Manipulation-1680x622.jpg)
...
method addresses this by splitting the job in two. A policy trained in Isaac Lab learns the general strategy for the assembly task in simulation. Then, on the actual hardware, a second layer learns to correct for whatever the simulator got wrong — using the robot’s own camera and without any human demonstrations or guidance.
...
framework takes on the next layer of difficulty in assembly: tasks with multiple sequential steps, where how step one is finished determines whether step two is even possible. It’s like assembling furniture — leave a panel at the wrong angle, and the next fastener won’t go in.
...
pipeline helps robots see past the clutter. In a typical manipulation task, the robot’s camera picks up everything in the scene — but most of it is irrelevant noise.
...
— a collaboration with researchers at Carnegie Mellon University, University of Utah and University of Sydney — addresses a specific failure mode that matters more as robots tackle longer, more complex tasks.
...
In addition to papers, NVIDIA is expanding
[robotics research](https://www.nvidia.com/en-us/research/robotics/)

infrastructure with large-scale open datasets for robotics.

The
[NVIDIA Physical AI Dataset](https://huggingface.co/collections/nvidia/physical-ai)

is the world’s largest open dataset for physical development, surpassing 15 million+ downloads, while
[NVIDIA Isaac GR00T X Embodiment Sim](https://huggingface.co/datasets/nvidia/PhysicalAI-Robotics-GR00T-X-Embodiment-Sim)

has become one of the most-downloaded robotics datasets.
...
Examples include a paper from CMU demonstrating a
[robotic control framework](https://arxiv.org/abs/2603.03740)

trained in NVIDIA Isaac Lab and MIT work on
[large language model-guided reinforcement learning](https://arxiv.org/abs/2511.14565)

powered by NVIDIA GPUs.

*Explore*
[*NVIDIA Research’s physical AI work*](https://research.nvidia.com/)
*. Developers can get started with*
[*Isaac Lab and Isaac Sim*](https://developer.nvidia.com/isaac)
*.*

*Stay up to date by subscribing to our*
[*newsletter*](https://www.nvidia.com/en-us/industries/robotics/robotics-stay-informed/)
...
*,*
[*X*](https://x.com/NVIDIARobotics)
*and*
[*Facebook*](https://www.facebook.com/NVIDIARobotics)
*.*

*To start your robotics journey, enroll in our free NVIDIA*
[*Robotics Fundamentals courses*](https://www.nvidia.com/en-us/learn/learning-path/robotics/)
*today.*