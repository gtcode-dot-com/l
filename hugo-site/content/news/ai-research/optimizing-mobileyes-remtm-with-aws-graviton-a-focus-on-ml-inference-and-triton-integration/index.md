...
date: '2025-11-27T00:00:20.227102+00:00'
exported_at: '2025-11-27T00:00:22.999842+00:00'
feed: https://aws.amazon.com/blogs/machine-learning/feed
language: en
source_url: https://aws.amazon.com/blogs/machine-learning/optimizing-mobileyes-rem-with-aws-graviton-a-focus-on-ml-inference-and-triton-integration
structured_data:
  about: []
  author: ''
  description: 'In this post, we focus on one portion of the REM™ system: the automatic
    identification of changes to the road structure which we will refer to as Change
    Detection. We will share our journey of architecting and deploying a solution
    for Change Detection, the core of which is a deep learning model called CDNet.
    We will share real-life decisions and tradeoffs when building and deploying a
    high-scale, highly parallelized algorithmic pipeline based on a Deep Learning
    (DL) model, with an emphasis on efficiency and throughput.'
  headline: 'Optimizing Mobileye’s REM™ with AWS Graviton: A focus on ML inference
    and Triton integration'
  inLanguage: en
  keywords: []
  main_image: ''
  original_source: https://aws.amazon.com/blogs/machine-learning/optimizing-mobileyes-rem-with-aws-graviton-a-focus-on-ml-inference-and-triton-integration
  publisher:
    logo: /favicon.ico
    name: gtcode.com
title: 'Optimizing Mobileye’s REM™ with AWS Graviton: A focus on ML inference and
  Triton integration'
updated_at: '2025-11-27T00:00:20.227102+00:00'
url_hash: 7adde1256a29890104f0351c433ac3cdc80804db
---

*This post is written by Chaim Rand, Principal Engineer, Pini Reisman, Software Senior Principal Engineer, and Eliyah Weinberg, Performance and Technology Innovation Engineer, at Mobileye.*
*The Mobileye team would like to thank Sunita Nadampalli and Guy Almog from AWS for their contributions to this solution and this post.*

[Mobileye](https://www.mobileye.com/)
is driving the global evolution toward smarter, safer mobility by combining pioneering AI, extensive real-world experience, a practical vision for the advanced driving systems of today, and the autonomous mobility of tomorrow.
[Road Experience Management™](https://www.mobileye.com/technology/rem/)
...
*Mobileye Road Experience Management (REM)™ (Source:
...
In this post, we focus on one portion of the REM™ system: the automatic identification of changes to the road structure which we will refer to as
**Change Detection**
. We will share our journey of architecting and deploying a solution for Change Detection, the core of which is a deep learning model called CDNet. We will cover the following points:
...
3. Running the Change Detection pipeline on
   [AWS Graviton](https://aws.amazon.com/ec2/graviton/)
   based
   [Amazon Elastic Compute Cloud (Amazon EC2)](https://aws.amazon.com/ec2/)
   instances and its impact on deployment flexibility, ultimately resulting more than a 2x improvement in throughput.
...
![](https://d2908q01vomqb2.cloudfront.net/f1f836cb4ea6efb2a0b1b99f41ad8b103eff4b59/2025/11/26/ChangeDetection.png)
...
For our initial approach, we designed an auto-scaling solution based on multi-core EC2 CPU Spot Instances processing tasks that are streamed from
[Amazon Simple Queue Service (Amazon SQS)](https://aws.amazon.com/sqs/)
. As change detection tasks were received, they would be scheduled, distributed, and run in a new process on a vacant slot on one of the CPU instances. The instances would be scaled up and down based on the task load.
...
* **Increased latency**
  : Calling CDNet over the network rather than on the same device added significant latency.
* **Increased network traffic**
  : The relatively large payload of CDNet significantly increased network traffic, thereby further increasing latency.
...
AWS Graviton is a family of processors designed to deliver the best price performance for cloud workloads running in Amazon EC2. They are also optimized for ML workloads, including
...
) instructions, making them an ideal choice to run our batched deep learning inference workloads for our Change Detection systems. Leading machine learning frameworks such as PyTorch, TensorFlow, and ONNX have been optimized for Graviton processors.
...
**![](https://d2908q01vomqb2.cloudfront.net/f1f836cb4ea6efb2a0b1b99f41ad8b103eff4b59/2025/11/26/Chaim-rand-headshot.jpeg)
Chaim Rand**
is a Principal Engineer and machine learning algorithm developer working on deep learning and computer vision technologies for Autonomous Vehicle solutions at Mobileye.

**![](https://d2908q01vomqb2.cloudfront.net/f1f836cb4ea6efb2a0b1b99f41ad8b103eff4b59/2025/11/26/pini_photo-100x93.jpg)
Pini Reisman**
is a Software Senior Principal Engineer leading the Performance Engineering and Technological Innovation in the Engineering group in REM – the mapping group in Mobileye.

**![](https://d2908q01vomqb2.cloudfront.net/f1f836cb4ea6efb2a0b1b99f41ad8b103eff4b59/2025/11/26/Eliyah_photo-100x150.jpg)
Eliyah Weinberg**
is a Performance and scale optimization and technology innovation engineer at Mobileye REM.

**![](https://d2908q01vomqb2.cloudfront.net/f1f836cb4ea6efb2a0b1b99f41ad8b103eff4b59/2025/11/26/Sunita-100x108.jpg)
Sunita Nadampalli**
