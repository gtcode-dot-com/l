...
date: '2026-06-09T04:29:38.875510+00:00'
exported_at: '2026-06-09T04:29:40.123714+00:00'
...
structured_data:
  about: []
  author: ''
  description: New NVIDIA Research breakthroughs show how training at scale — across
    gripper types, driving scenarios and virtual worlds — creates AI that generalizes
    to diverse applications.
  headline: NVIDIA Research Unlocks Advanced Grasping, Smarter Autonomous Driving
    and Agent Training at Scale
  inLanguage: en
  keywords: []
  main_image: ''
  original_source: https://blogs.nvidia.com/blog/cvpr-research-grasping-driving-agent-training
  publisher:
    logo: /favicon.ico
    name: GTCode
title: NVIDIA Research Unlocks Advanced Grasping, Smarter Autonomous Driving and Agent
  Training at Scale
updated_at: '2026-06-09T04:29:38.875510+00:00'
url_hash: 46e114a073d8c6c05bf0be877b410be6d74bdaa7
---
...
* **GraspGen-X**
  ...
  , the first foundation model for zero-shot grasping, was trained on billions of simulated grasps to work with any gripper it’s shown.
* **LCDrive**

  introduces a model that replaces expensive text-based reasoning with compact latent representations, letting autonomous vehicles think faster on embedded hardware.
* **NitroGen**

  is a generalized gameplay AI foundation model that harnesses the
  [NVIDIA Isaac GR00T](https://developer.nvidia.com/isaac/gr00t)

  robot foundation model architecture to help train embodied agents in virtual environments across tens of thousands of hours of interaction.

NVIDIA also unveiled at CVPR
[new physical AI agent skills](https://blogs.nvidia.com/blog/cvpr-physical-ai-research-agent-skills)

that help researchers and developers speed the development of autonomous vehicles, robots and vision AI systems.

NitroGen and another NVIDIA-authored paper,
[PixelDIT](https://pixeldit.github.io)
, were named best paper finalists at the conference — an accolade given to just 15 of over 4,000 accepted papers at CVPR.
...
A
[vision-language-action](https://www.nvidia.com/en-us/glossary/reasoning-vision-language-action/)
...
[**GraspGen-X**](https://graspgenx.github.io/)

is the first foundation model for grasping built to eliminate this bottleneck.
...
For robot developers, this foundation model eliminates the need for per-gripper training cycles and can be applied out of the box for several commonly used grippers. GraspGenX can be used in conjunction with
[curoboV2](https://curobo.org/)

, a new CUDA-accelerated motion planning library, to achieve these grasp poses in unknown environments.

Building on the GraspGen research foundation, another paper,
[Grasp-MPC — presented at ICRA 2026](https://blogs.nvidia.com/blog/icra-research-robotics-simulation-to-real-world/)

— advances the next step in the pipeline: moving from grasp generation to closed-loop grasp execution.
...
tackles this problem by replacing words with compressed latent representations.
...
and trained using supervision derived from existing vehicle data.
...
extends that principle to virtual environments, using the GR00T architecture to train a foundation model for embodied agents across a breadth of virtual worlds.
...
The model is open source, available on
[GitHub](https://github.com/MineDojo/NitroGen)

and
[Hugging Face](https://huggingface.co/nvidia/NitroGen)
