...
structured_data:
  about: []
  author: ''
  description: For more than a decade, MIT Associate Professor Rafael Gómez-Bombarelli
    has used artificial intelligence to create new materials. Now, he believes AI
    is poised to transform science in ways never before possible.
  headline: Accelerating science with AI and simulations
  inLanguage: en
  keywords: []
  main_image: ''
  original_source: https://news.mit.edu/2026/accelerating-science-ai-and-simulations-rafael-gomez-bombarelli-0212
  publisher:
    logo: /favicon.ico
    name: gtcode.com
...
When he first came to MIT,
Gómez-Bombarelli says he was blown away by how non-competitive things were between researchers. He tries to bring that same positive-sum thinking to his research group, which is made up of about 25 graduate students and postdocs.
