...
date: '2026-08-09T09:50:28.006127+00:00'
exported_at: '2026-08-09T09:50:31.327820+00:00'
...
structured_data:
  about: []
  author: ''
  description: AI agents can't remember past conversations. They must constantly reload
    or retrieve context, which grows less efficient as tasks get longer and more complex.
    Memora solves this with a scalable memory system separating what’s stored from
    how it's retrieved.
  headline: 'Memora: A Harmonic Memory Representation Balancing Abstraction and Specificity'
  inLanguage: en
  keywords: []
  main_image: ''
  original_source: https://www.microsoft.com/en-us/research/blog/memora-a-harmonic-memory-representation-balancing-abstraction-and-specificity
  publisher:
    logo: /favicon.ico
    name: GTCode
title: Memora: A Harmonic Memory Representation Balancing Abstraction and Specificity
updated_at: '2026-08-09T09:50:28.006127+00:00'
url_hash: 05c30363cdc170537958f2e863fcee5c38e2d6ab
---

![Three minimalist white icons on a purple-to-pink gradient background. From left to right: an hourglass, a circular gauge, and a pair of angle brackets with a slash.](https://www.microsoft.com/en-us/research/wp-content/uploads/2026/06/Memora-BlogHeroFeature-1400x788-1-1024x576.jpg)
...
* **Memora**
  ...
  ***how***
  it’s retrieved (lightweight abstractions and cue anchors), balancing abstraction and specificity.
...
* [Memora paper
  (opens in new tab)](https://arxiv.org/abs/2602.03315)
  is published at ICML 2026. Memora code is available at
  [https://github.com/microsoft/Memora
  (opens in new tab)](https://github.com/microsoft/Memora)
  .
...
[**Memora**](https://www.microsoft.com/en-us/research/publication/memora-a-harmonic-memory-representation-balancing-abstraction-and-specificity/)
...
![Overview of the Memora architecture showing how multimodal data is segmented, converted into structured memory entries and an implicit memory graph, then retrieved through a policy-driven process optimized with group-relative learning to return relevant episodic memories.](https://www.microsoft.com/en-us/research/wp-content/uploads/2026/06/figure_1_high_res_Memora-1-scaled.png)
...
![Bar chart comparing LoCoMo overall scores across memory systems using LLM-judge, F1, and BLEU metrics. Memora (P) achieves the highest LLM-judge score (0.863), followed by Memora (S) (0.849) and Full Context (0.825). Memora variants outperform other memory-based approaches across all three metrics.](https://www.microsoft.com/en-us/research/wp-content/uploads/2026/06/figure_2_high_res_Memora-1-scaled.png)
...
[Rujia Wang](https://www.microsoft.com/en-us/research/people/rujiawang/)
,
[Victor Rühle](https://www.microsoft.com/en-us/research/people/virueh/)
, and
[Robert Sim](https://www.microsoft.com/en-us/research/people/rsim/)
