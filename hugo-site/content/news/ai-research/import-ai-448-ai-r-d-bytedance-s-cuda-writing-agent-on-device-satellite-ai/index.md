...
structured_data:
  about: []
  author: ''
  description: If Ukraine is the first major drone war, when will there be the first
    major AI war?
  headline: 'Import AI 448: AI R&D; Bytedance''s CUDA-writing agent; on-device satellite
    AI'
  inLanguage: en
  keywords: []
  main_image: ''
  original_source: https://importai.substack.com/p/import-ai-448-ai-r-and-d-bytedances
  publisher:
    logo: /favicon.ico
    name: GTCode
...
[I underestimated AI capabilities (again) (Ajeya Cotra)](https://www.planned-obsolescence.org/p/i-underestimated-ai-capabilities)
...
[Measuring AI R&D Automation (arXiv)](https://arxiv.org/abs/2603.03992)
...
:
[Scaling Real-Time Traffic Analytics on Edge-Cloud Fabrics for City-Scale Camera Networks (arXiv)](https://arxiv.org/abs/2603.05217)
...
:
[TinyIceNet: Low-Power SAR Sea Ice Segmentation for On-Board FPGA Inference (arXiv)](https://arxiv.org/abs/2603.03075)
...
[CUDA Agent: Large-Scale Agentic RL for High-Performance CUDA Kernel Generation (arXiv)](https://arxiv.org/abs/2602.24286)
