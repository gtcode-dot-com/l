...
structured_data:
  about: []
  author: ''
  description: The worldwide tour of NVIDIA AI Days — bringing together AI enthusiasts,
    developers, researchers and startups — made its latest stop in São Paulo, Brazil.
  headline: 'Code, Compute and Connection: Inside the Inaugural NVIDIA AI Day São
    Paulo'
  inLanguage: en
  keywords: []
  main_image: ''
  original_source: https://blogs.nvidia.com/blog/ai-day-sao-paulo
  publisher:
    logo: /favicon.ico
    name: gtcode.com
...
*Editor’s note: This post is part of a blog series highlighting*
[*NVIDIA AI Days*](https://blogs.nvidia.com/blog/tag/ai-days/)
*across the globe.*
...
![](https://blogs.nvidia.com/wp-content/uploads/2026/02/sao-paulo-check-in-scaled.jpeg)

Attendees check in at NVIDIA AI Day São Paulo.

More than 500 attendees joined NVIDIA AI Day São Paulo in January to learn about
[sovereign AI](https://blogs.nvidia.com/blog/what-is-sovereign-ai/)
— including breakout sessions on AI agents and open models.
...
!["NVIDIA’s GPUs, algorithms and frameworks accelerate the results we are capable of delivering by hundreds of times," said Paulo Perez, cofounder and CEO of Biofy.](https://blogs.nvidia.com/wp-content/uploads/2026/02/paulo-perez-pull-quote-scaled.jpg)
...
The
[Brazilian Artificial Intelligence Plan for 2024-2028](https://www.gov.br/g20/en/news/brasil-launches-a-usd-4-billion-plan-for-ai-and-prepares-global-action)
, called “AI for the Good of All,” outlines 50+ targeted initiatives across public services, R&D, infrastructure, industry and government.
...
![](https://blogs.nvidia.com/wp-content/uploads/2026/02/sao-paulo-all-conference-session-scaled.jpeg)
...
![Infographic that says there are 1,000 NVIDIA Inception startups in Brazil, 40 Brazilian universities engaging with NVIDIA, 19,000 NVIDIA Deep Learning Institute trainees in Brazil, 47 million CUDA downloads from Brazil and 123,000 developers in Brazil using NVIDIA technologies.](https://blogs.nvidia.com/wp-content/uploads/2026/02/sao-paulo-infographic-scaled.jpg)

## Event Highlights

In addition to four
[NVIDIA Deep Learning Institute](https://www.nvidia.com/en-us/training/)
technical labs, the event featured sessions on the fundamentals to AI agent creation as well as large language model (LLM) and retrieval-augmented generation labs focused on accelerated linguistic diversity.

An all-conference plenary session hosted by the
[NVIDIA Inception](https://www.nvidia.com/en-us/startups/)
program for startups featured Howard Wright, vice president of startups ecosystem at NVIDIA, who discussed how sovereign AI empowers Brazil to unlock national potential, fostering economic growth, technological autonomy and leadership in the regional AI landscape.
...
![](https://blogs.nvidia.com/wp-content/uploads/2026/02/sao-paulo-sovereign-ai-session-scaled.jpeg)
...
![](https://blogs.nvidia.com/wp-content/uploads/2026/02/sao-paulo-inception-session-scaled.jpeg)
