...
structured_data:
  about: []
  author: ''
  description: What might a superintelligence arcology be like?
  headline: 'Import AI 447: The AGI economy; testing AIs with generated games; and
    agent ecologies'
  inLanguage: en
  keywords: []
  main_image: ''
  original_source: https://importai.substack.com/p/import-ai-447-the-agi-economy-testing
  publisher:
    logo: /favicon.ico
    name: GTCode
...
[Some Simple Economics of AGI (arXiv)](https://arxiv.org/abs/2602.20946)
...
:
[“How Fast Will A.I. Agents Rip Through the Economy? | The Ezra Klein Show” (YouTube).](https://www.youtube.com/watch?v=lIJelwO8yHQ)
...
**Read more:**
[LLM Novice Uplift on Dual-Use, In Silico Biology Tasks (arXiv)](https://arxiv.org/abs/2602.23329)
...
:
[AI Gamestore: Scalable, Open-Ended Evaluation of Machine General Intelligence with Human Games (arXiv)](https://arxiv.org/abs/2602.17594)
...
at
[the official site (AI Gamestore)](http://aigamestore.org)
...
[The Physical Intelligence Layer (Physical Intelligence, blog)](https://www.pi.website/blog/partner?v=1)
...
at the
[Agents of Chaos official website](https://agentsofchaos.baulab.info/)
