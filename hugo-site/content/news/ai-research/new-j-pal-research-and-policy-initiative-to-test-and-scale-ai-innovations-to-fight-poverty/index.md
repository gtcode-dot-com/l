...
structured_data:
  about: []
  author: ''
  description: 'Project AI Evidence, a new J-PAL research and policy initiative, will
    fund impact evaluations of AI innovations in the fight against poverty and scale
    up those that are most successful, in collaboration with governments, tech companies,
    NGOs, and researchers. '
  headline: New J-PAL research and policy initiative to test and scale AI innovations
    to fight poverty
  inLanguage: en
  keywords: []
  main_image: ''
  original_source: https://news.mit.edu/2026/new-j-pal-research-policy-initiative-to-test-scale-ai-innovations-fight-poverty-0212
  publisher:
    logo: /favicon.ico
    name: gtcode.com
...
The Abdul Latif Jameel Poverty Action Lab (J-PAL) at MIT has awarded funding to eight new research studies to understand how artificial intelligence innovations can be used in the fight against poverty through its new
[Project AI Evidence](https://www.povertyactionlab.org/initiative/partnership-ai-evidence-paie)
.
...
J-PAL is uniquely positioned to help understand AI’s effects on society: Since its inception in 2003, J-PAL’s network of researchers has led over 2,500 rigorous evaluations of social policies and programs around the world. Through PAIE, J-PAL will bring together leading experts in AI technology, research, and social policy, in alignment with MIT president Sally Kornbluth’s focus on generative AI as a
[strategic priority](https://president.mit.edu/writing-speeches/launching-mit-generative-ai-impact-consortium)
.

PAIE is chaired by Professor
[Joshua Blumenstock](https://www.povertyactionlab.org/person/blumenstock)
of the University of California at Berkeley; J-PAL Global Executive Director
[Iqbal Dhaliwal](https://www.povertyactionlab.org/person/dhaliwal)
; and Professor
[David Yanagizawa-Drott](https://www.povertyactionlab.org/person/yanagizawa-drott)
...
Existing
[research](https://www.povertyactionlab.org/policy-insight/tailoring-instruction-students-learning-levels-increase-learning)
shows that personalized learning is important for students, but challenging to implement with limited resources. In Kenya, education social enterprise EIDU has developed an AI tool that helps teachers identify learning gaps and adapt their daily lesson plans. In India, the nongovernmental organization (NGO) Pratham is developing an AI tool to increase the impact and scale of the evidence-informed
[Teaching at the Right Level](https://www.povertyactionlab.org/case-study/teaching-right-level-improve-learning)
approach. J-PAL researchers Daron Acemoglu, Iqbal Dhaliwal, and Francisco Gallego will work with both organizations to study the effects and potential of these different use cases on
[teachers’ productivity and students’ learning](https://www.povertyactionlab.org/initiative-project/ai-powered-structured-pedagogy-programs-impact-student-learning-and-teacher)
.

**Can AI tools reduce gender bias in schools?**

Researchers are collaborating with Italy’s Ministry of Education to evaluate whether AI tools can help
[close gender gaps in students’ performance](https://www.povertyactionlab.org/initiative-project/ai-powered-structured-pedagogy-programs-impact-student-learning-and-teacher)
...
In Kenya, researchers are evaluating if an AI tool can
[identify overlooked skills and unlock employment opportunities](https://www.povertyactionlab.org/initiative-project/learning-recommend-ai-human-counselors-and-job-matching-kenya)
...
To learn more about Project AI Evidence,
[subscribe](https://povertyactionlab.org/subscribe)
to J-PAL's newsletter or contact
[paie@povertyactionlab.org](mailto:paie@povertyactionlab.org)
.