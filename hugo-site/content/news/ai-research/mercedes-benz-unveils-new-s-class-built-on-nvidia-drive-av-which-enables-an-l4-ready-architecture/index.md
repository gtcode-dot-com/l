...
structured_data:
  about: []
  author: ''
  description: NVIDIA will deliver premium autonomous rides based on the new Mercedes-Benz
    S-Class, including through Uber’s global mobility platform.
  headline: Mercedes-Benz Unveils New S-Class Built on NVIDIA DRIVE AV, Which Enables
    an L4-Ready Architecture
  inLanguage: en
  keywords: []
  main_image: ''
  original_source: https://blogs.nvidia.com/blog/mercedes-benz-l4-s-class-drive-av-platform
  publisher:
    logo: /favicon.ico
    name: gtcode.com
...
Mercedes-Benz is marking 140 years of automotive innovation with a new S-Class built for the AI era, bringing together automotive safety and
[NVIDIA’s advanced autonomous driving platform](https://www.nvidia.com/en-us/solutions/autonomous-vehicles/)
to enable a
[level 4-ready](https://blogs.nvidia.com/blog/level-4-autonomous-driving-ai/)
architecture designed for trust.

The new S-Class with MB.OS, which will be equipped with the NVIDIA DRIVE Hyperion architecture and full-stack
[NVIDIA DRIVE AV](https://www.nvidia.com/en-us/solutions/autonomous-vehicles/drive-av/)
L4 software, is designed to support future robotaxi operations — delivering safety-first autonomy with the NVIDIA Halos system and end-to-end AI and classical driving stacks running in parallel to ensure reliable operation.

The S-Class enables a premium, chauffeur-style autonomous experience. As part of NVIDIA’s previously announced
[partnership with Uber](https://nvidianews.nvidia.com/news/nvidia-uber-robotaxi)
, the companies will work together to make these autonomous vehicles available to riders through Uber’s mobility network.

It showcases how legacy automakers and AI pioneers can
[work together](https://www.nvidia.com/en-us/solutions/autonomous-vehicles/partners/mercedes/)
to build vehicles that are safer, smarter and increasingly autonomous — without compromising the high standards of quality and safety customers expect.
...
The new S-Class will be built on
[NVIDIA DRIVE Hyperion](https://www.nvidia.com/en-us/solutions/autonomous-vehicles/drive-hyperion)
, a reference architecture that integrates sensor diversity and hardware redundancy into a unified platform, to serve as a robotaxi.
...
safety system, NVIDIA DRIVE Hyperion helps eliminate single points of failure and provides the foundation needed for L4-ready systems.
...
![](https://blogs.nvidia.com/wp-content/uploads/2026/01/mb-s-class-2026-960x641.jpg)

## **From AI Foundations to Production-Ready Autonomy**

NVIDIA’s broader AI ecosystem — including the
[NVIDIA Alpamayo](https://www.nvidia.com/en-us/solutions/autonomous-vehicles/alpamayo/)
family of open models, simulation tools and datasets for autonomous vehicles — enables developers and partners to advance autonomous driving research and build their own driving software.
...
This approach reflects a broader shift toward active, intelligent safety — a trend already recognized by independent testing, including the Mercedes-Benz CLA’s designation as
[Euro NCAP’s Best Performer of 2025](https://blogs.nvidia.com/blog/drive-av-mercedes-benz-cla-euro-ncap-safety-award/)
.
