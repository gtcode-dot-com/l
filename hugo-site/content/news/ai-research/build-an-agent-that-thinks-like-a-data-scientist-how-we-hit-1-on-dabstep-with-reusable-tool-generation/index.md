...
date: '2026-03-13T03:47:22.397176+00:00'
exported_at: '2026-03-13T03:47:24.644991+00:00'
...
structured_data:
  ...
  headline: 'Build an Agent That Thinks Like a Data Scientist: How We Hit #1 on DABStep
    with Reusable Tool Generation'
  keywords: []
  main_image: ''
  original_source: https://huggingface.co/blog/nvidia/nemo-agent-toolkit-data-explorer-dabstep-1st-place
  publisher:
    logo: /favicon.ico
    name: GTCode
title: 'Build an Agent That Thinks Like a Data Scientist: How We Hit #1 on DABStep
  with Reusable Tool Generation'
updated_at: '2026-03-13T03:47:22.397176+00:00'
url_hash: 4e558c1ba7e59b019bc57b20b7704a4fd247507c
---

# Build an Agent That Thinks Like a Data Scientist: How We Hit #1 on DABStep with Reusable Tool Generation

The world of data is vast, but quantitative information is often sparse or unavailable in text form online, presenting a significant challenge for deep research agents. This post shares an architecture,

**NVIDIA KGMON (NeMo Agent Toolkit) Data Explorer**

, for building autonomous data analysis agents, developed by the

**NVIDIA Kaggle Grandmasters (KGMON) LLM Agent Research Team**

. The

**NVIDIA KGMON (NeMo Agent Toolkit) Data Explorer**

project introduces an agent specialized for dataset exploration and analysis, designed to handle the complexities of multi-step reasoning, tool calling, and iterative data analysis. Notably, our approach establishes

**new state-of-the-art (SOTA) performance on the
[Data Agent Benchmark for Multi-step Reasoning (DABStep)](https://huggingface.co/spaces/adyen/DABstep)
benchmark, ranking 1st place with a 30x speedup over the claude code baseline**
...
**NVIDIA KGMON (NeMo Agent Toolkit) Data Explorer**
aims to deliver capabilities including automatic open-ended exploratory data analysis, tabular data Q&A, predictive modeling, and forecasting.

## The NVIDIA KGMON (NeMo Agent Toolkit) Data Explorer Architecture

In
**NVIDIA KGMON (NeMo Agent Toolkit) Data Explorer**
, we implement different agent loops for different use cases. The architecture leverages the
[NVIDIA NeMo Agent Toolkit](https://github.com/NVIDIA/NeMo-Agent-Toolkit)
to drive these loops, utilizing tools designed specifically from a data scientist's perspective. For open-ended exploratory data analysis, the system pairs a ReAct agent with a Jupyter Notebook tool, allowing for continuous, bi-directional interaction. Alternatively, for multi-step rule-based tabular data QA, the architecture utilizes a Tool Calling Agent. This agent interacts with a distinct, multi-part suite of specialized tools to accomplish its structured tasks: a stateful Python interpreter, a retriever, and a file structure detector.

[![Screenshot 2026-03-09 at 9.25.43 PM](https://cdn-uploads.huggingface.co/production/uploads/627fbbe9b846ecb5f28e6d0c/5xeftVBU6YGF-k_gld2tc.png)](https://cdn-uploads.huggingface.co/production/uploads/627fbbe9b846ecb5f28e6d0c/5xeftVBU6YGF-k_gld2tc.png)
...
[![Screenshot 2026-03-09 at 9.26.39 PM](https://cdn-uploads.huggingface.co/production/uploads/627fbbe9b846ecb5f28e6d0c/L8cyMYA6_hKhn3ppxbPnV.png)](https://cdn-uploads.huggingface.co/production/uploads/627fbbe9b846ecb5f28e6d0c/L8cyMYA6_hKhn3ppxbPnV.png)
...
[![Screenshot 2026-03-09 at 9.31.04 PM](https://cdn-uploads.huggingface.co/production/uploads/627fbbe9b846ecb5f28e6d0c/6nec5ozaptPkflfYnA5Er.png)](https://cdn-uploads.huggingface.co/production/uploads/627fbbe9b846ecb5f28e6d0c/6nec5ozaptPkflfYnA5Er.png)
...
[![Screenshot 2026-03-09 at 9.32.07 PM](https://cdn-uploads.huggingface.co/production/uploads/627fbbe9b846ecb5f28e6d0c/ibMLfUIhwfpkys-s78dOC.png)](https://cdn-uploads.huggingface.co/production/uploads/627fbbe9b846ecb5f28e6d0c/ibMLfUIhwfpkys-s78dOC.png)
...
[![Screenshot 2026-03-09 at 9.34.09 PM](https://cdn-uploads.huggingface.co/production/uploads/627fbbe9b846ecb5f28e6d0c/54Fds7AsdY4to32oLDjM3.png)](https://cdn-uploads.huggingface.co/production/uploads/627fbbe9b846ecb5f28e6d0c/54Fds7AsdY4to32oLDjM3.png)
...
[![Screenshot 2026-03-09 at 9.36.21 PM](https://cdn-uploads.huggingface.co/production/uploads/627fbbe9b846ecb5f28e6d0c/riDH6vggZ8-Qo4lclO5M_.png)](https://cdn-uploads.huggingface.co/production/uploads/627fbbe9b846ecb5f28e6d0c/riDH6vggZ8-Qo4lclO5M_.png)
...
[![Screenshot 2026-03-09 at 9.37.57 PM](https://cdn-uploads.huggingface.co/production/uploads/627fbbe9b846ecb5f28e6d0c/krvQUvh_QRkmvEx_hP015.png)](https://cdn-uploads.huggingface.co/production/uploads/627fbbe9b846ecb5f28e6d0c/krvQUvh_QRkmvEx_hP015.png)
...
Ready to build your own data exploration agent? Get started with
[NVIDIA Launchable](https://docs.nvidia.com/brev/latest/launchables.html)
