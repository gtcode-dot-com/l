...
structured_data:
  about: []
  author: ''
  description: Drawn by the chance to tackle new problems and cutting-edge algorithm
    development, Ivy Mahncke undertook an internship with MIT Lincoln Laboratory,
    developing an algorithm that would help a human diver and robotic vehicle navigate
    underwater.
  headline: 'Featured video: Coding for underwater robotics'
  inLanguage: en
  keywords: []
  main_image: ''
  original_source: https://news.mit.edu/2026/featured-video-coding-underwater-robotics-0227
  publisher:
    logo: /favicon.ico
    name: GTCode
