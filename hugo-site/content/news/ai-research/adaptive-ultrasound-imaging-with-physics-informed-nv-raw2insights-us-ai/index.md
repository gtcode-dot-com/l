...
date: '2026-04-28T02:15:35.476454+00:00'
exported_at: '2026-04-28T02:15:37.632674+00:00'
...
structured_data:
  ...
  headline: Adaptive Ultrasound Imaging with Physics-Informed NV-Raw2Insights-US AI
  keywords: []
  main_image: ''
  original_source: https://huggingface.co/blog/nvidia/raw2insights-adaptive-ultrasound-imaging
  publisher:
    logo: /favicon.ico
    name: GTCode
title: Adaptive Ultrasound Imaging with Physics-Informed NV-Raw2Insights-US AI
updated_at: '2026-04-28T02:15:35.476454+00:00'
url_hash: efd836dfee62cd994efcc988f630b21dd0926835
---

# Adaptive Ultrasound Imaging with Physics-Informed NV-Raw2Insights-US AI

[![image (8)](https://cdn-uploads.huggingface.co/production/uploads/6982afd67f2b9204df10347c/14E-6Z6Vs33huLIxDQuUt.png)](https://cdn-uploads.huggingface.co/production/uploads/6982afd67f2b9204df10347c/14E-6Z6Vs33huLIxDQuUt.png)
...
[![image2](https://cdn-uploads.huggingface.co/production/uploads/6982afd67f2b9204df10347c/F9BumpKK7St__NHdItT_E.png)](https://cdn-uploads.huggingface.co/production/uploads/6982afd67f2b9204df10347c/F9BumpKK7St__NHdItT_E.png)
...
[![image3](https://cdn-uploads.huggingface.co/production/uploads/6982afd67f2b9204df10347c/Pb2J85xua_av7mur20fF9.png)](https://cdn-uploads.huggingface.co/production/uploads/6982afd67f2b9204df10347c/Pb2J85xua_av7mur20fF9.png)

In this first Raw2Insights application we estimate speed of sound for adaptive image focusing. The result is a system that can generate a personalized map of sound speed for each patient—and use it to correct the image in real time. What once required complex, time-consuming computation is now performed in a single AI pass. This is the shift from
*raw ultrasound channel data*
to
*actionable insight*
: an AI system that doesn’t just process ultrasound images, but actively understands and adapts to the physics of each individual patient.

## Deployment

Typically raw ultrasound channel data is not easily accessible on clinical grade ultrasound scanners due to its high-bandwidth.
[Holoscan Sensor Bridge](https://www.nvidia.com/en-us/technologies/holoscan-sensor-bridge/)
(HSB), is an open source FPGA IP developed by NVIDIA that allows high-bandwidth low latency data transfer to the GPU via
[(](https://www.google.com/search?q=RoCE+%28&sca_esv=b2010e30be87c2d7&sxsrf=ANbL-n462J72mSiMPiw6gMQhK3i2ODp--A%3A1773940279648&ei=Ny68af6gJ52n0PEPr9Se4AM&biw=1193&bih=623&ved=2ahUKEwjZkpbEuqyTAxVHDjQIHWBfHHsQgK4QegQIARAB&uact=5&oq=RoCe+nviida&gs_lp=-U1sgcFMC41LjG4B9QHwgcHMC40LjIuMcgHIYAIAA&sclient=gws-wiz-serp)
...
We deploy NV-Raw2Insights-US using
**NVIDIA Holoscan**
, an edge AI sensor processing platform designed for high-performance, real-time workloads on systems such as
**NVIDIA IGX Thor**
and
**NVIDIA DGX Spark**
.

Once the data is in GPU memory, NV-Raw2Insights-US runs accelerated inference on a
**Blackwell-class GPU**
, producing a patient-specific sound-speed estimate. This estimate is streamed back to the ultrasound scanner, enabling improved focus in the live imaging stream.
...
This architecture not only improves image clarity today, but also establishes a modular foundation for the next generation of AI-powered diagnostic systems. You can get started developing on top of NV-Raw2Insights-US here (
[GitHub](https://github.com/NVIDIA-Medtech/NV-Raw2insights-US)
/
[Model Weights](https://huggingface.co/nvidia/NV-Raw2Insights-US)
/
[Dataset](https://huggingface.co/datasets/nvidia/NV-Raw2Insights-US)
).

#### References

1. **"Ultrasound Autofocusing: Common Midpoint Phase Error Optimization via Differentiable Beamforming,"**
   *IEEE Transactions on Medical Imaging*
   , Vol. 45, Issue 2, Feb. 2026.
   <https://ieeexplore.ieee.org/document/11154013>
2. **"Investigating Pulse-Echo Sound Speed Estimation in Breast Ultrasound with Deep Learning,"**
   *arXiv:2302.03064*
   , 2023.
   <https://arxiv.org/abs/2302.03064>
3. **NVIDIA Holoscan SDK Documentation**
   ,
