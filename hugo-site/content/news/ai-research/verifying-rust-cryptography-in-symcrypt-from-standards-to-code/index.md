...
date: '2026-08-09T09:45:20.316570+00:00'
exported_at: '2026-08-09T09:45:22.853047+00:00'
...
structured_data:
  about: []
  author: ''
  description: 'Cryptographic code supports vital protections in modern computing
    systems. Learn how a new method helps verify code as developers write it while
    preserving speed and adaptability as it gets implemented and evolves:'
  headline: Verifying Rust cryptography in SymCrypt, from standards to code
  inLanguage: en
  keywords: []
  main_image: ''
  original_source: https://www.microsoft.com/en-us/research/blog/verifying-rust-cryptography-in-symcrypt-from-standards-to-code
  publisher:
    logo: /favicon.ico
    name: GTCode
title: Verifying Rust cryptography in SymCrypt, from standards to code
updated_at: '2026-08-09T09:45:20.316570+00:00'
url_hash: 35de7256d0278847f165c9a32d6900eeaec80df8
---

## How Rust, Lean, Aeneas, and AI agents are helping scale formal verification for production cryptographic algorithms

![Diagram showing the process of verifying cryptographic code. An algorithm from a standard is converted into a formal specification, while Rust code is converted into a code model. The specification and code model are then compared through proof and verification steps.](https://www.microsoft.com/en-us/research/wp-content/uploads/2026/07/RustSymCrypt-BlogHeroFeature-1400x788-1-1024x576.jpg)
...
[formally verify new algorithms written in Rust in SymCrypt](https://www.microsoft.com/en-us/research/blog/rewriting-symcrypt-in-rust-to-modernize-microsofts-cryptographic-library/)
...
[Lean
(opens in new tab)](https://lean-lang.org/)
formal proof framework using the
[Aeneas
(opens in new tab)](https://github.com/AeneasVerif/aeneas)
...
![Agents (stochastic, in blue) and tools (algorithmic, in green) for software verification. Human effort focuses on reviewing formalization of standards and main properties. Agents write proofs and intermediate properties. Compilation, code extraction, and proof verification are deterministic, not agentic.](https://www.microsoft.com/en-us/research/wp-content/uploads/2026/07/image-1.png)
...
[SymCrypt branch
(opens in new tab)](https://github.com/microsoft/SymCrypt/tree/feature/verifiedcrypto)
...
![Screenshot of a verified formal specification for the symcrust::mlkem::ntt function. The page shows a green “Verified” badge, links to the Lean model and source code, and a specification stating the mathematical conditions the NTT implementation must satisfy.](https://www.microsoft.com/en-us/research/wp-content/uploads/2026/07/FIG3_SymCrypt.png)
