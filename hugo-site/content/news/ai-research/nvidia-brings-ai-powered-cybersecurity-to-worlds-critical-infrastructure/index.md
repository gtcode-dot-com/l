...
structured_data:
  about: []
  author: ''
  description: Akamai, Forescout, Palo Alto Networks, Xage Security and Siemens integrate
    NVIDIA accelerated computing and AI to advance OT cybersecurity.
  headline: NVIDIA Brings AI-Powered Cybersecurity to World’s Critical Infrastructure
  inLanguage: en
  keywords: []
  main_image: ''
...
[NVIDIA BlueField DPUs](https://www.nvidia.com/en-us/networking/products/data-processing-unit/)
run security services on dedicated hardware, keeping protection separate from operational systems so critical processes remain unaffected.
...
*NVIDIA-powered OT cybersecurity solutions are delivered through a global ecosystem of trusted partners. Read this
[OT cybersecurity use case](https://www.nvidia.com/en-us/use-cases/operational-technology-security/)
and
[solution overview](https://resources.nvidia.com/en-us-accelerated-networking-resource-library/bluefield-solution-overview-ot-security-4890569)
for more.*

*Join*
[*NVIDIA at S4x26*](https://s4xevents.com/agenda/)
*, running Feb. 24–26 in Miami, to see how accelerated computing and AI are transforming cybersecurity for OT and critical infrastructure.*