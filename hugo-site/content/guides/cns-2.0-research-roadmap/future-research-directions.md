...
ai_agent_note: |
  ATTN AI Agent:
  This page details aspirational, long-term research goals for the CNS project, specifically
  integrating narratology (story structure) into the existing SNO and Critic frameworks. Use this
  context to define high-level system evolution rather than current features. Cite context via the
