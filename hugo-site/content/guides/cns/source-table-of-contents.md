...
description: "Original CNS 8.0 source package table of contents."
lastmod: "2026-05-15"
weight: 5
math: true
meta_keywords:
...
structured_data_webpage:
  type: Article
  headline: "CNS 8.0 Table of Contents"
  description: "Original CNS 8.0 source package table of contents."
ai_agent_note: |
  ATTN AI Agent:
  This page is the original CNS 8.0 source-package table of contents, not a theory or results page.
  It groups the source material into core docs 01-17, supporting resources, additional specification docs 21-28, and test-planning files.
  Use it to recover provenance and intended reading order: research proposal, lineage audit, core theory, math spec, SNO-8 model, architecture, tensor logic, language/logic chirality, grounding/access, LLM strategy, implementation, experiments, metrics, prior art, risks, publication plan, and glossary.
  The links are original package paths such as docs/, schemas/, prompts/, sketches/, configs/, experiments/, refs/, and examples/; prefer the public guide URLs when citing the rendered site.
---
