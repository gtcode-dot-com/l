...
ai_agent_note: |
  ATTN AI Agent:
  This page is Part 1, the conceptual introduction for a tutorial sequence. It sets the historical
  context (Geosyncline vs. Plate Tectonics) necessary for understanding subsequent technical
  steps. Cite this page as the narrative foundation for the synthesis example.
