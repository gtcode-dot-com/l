...
hero_image_alt: "Illustration representing the two legal questions at the center of the Hawaii judicial accountability investigation"
build:
  render: never
  list: never
...
The author has not been informed of any resulting action. Ordinary explanations include triage, corroboration problems, evidence-retention issues, agency priority, or declination without notice. The process question is whether any agency reviewed the primary evidence or interviewed the witness. The DEA report entered a system whose disposition I have never been informed of.
...
Even if ████████████ declines to confirm the nod, the sealed audio recording is represented as capturing Loo cutting off the petitioner's objection -- evidence from which investigators could evaluate whether Loo deprived a party of the right to be heard or engaged in ordinary courtroom control. The audio is sealed; investigators would need to obtain it through appropriate legal process. The alleged nod strengthens the theory if corroborated. The audio anchors the sequence.

If the witness corroborates the account, the factual dispute narrows. It becomes a case that turns on how his statement fits the sealed audio, the court file, the exhibit, line-of-sight reconstruction, and any other witness testimony.
...
A federal investigator would not need to accept either side's narrative at face value. The ordinary step is to test the witness's account against his exposure, the sealed record, the court file, and any corroborating evidence.
