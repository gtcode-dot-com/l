# OAHU UNDERGROUND — NETWORK MAP: MASTER NODE LIST (v3)
...
First appears: Issue 1
Key edges: BF-0 (son-in-law); BF-1 (brother-in-law); JD-2 (spouse); BF-2 (disclosed financial holdings >$2M in Luke entities); JD-3 (financial disclosures filed with); OV-1 (Commission member — exact title/dates to be verified against Commission records before publication); NP-3, NP-8 (board roles); JD-5 (Dec 2, 2022 hearing — Issue 4)
...
First appears: Issue 1
Key edges: BF-0 (daughter); BF-1 (sister); JD-1 (spouse); ED-1 (alumna, retired teacher); NP-3 (board, Vice-Chair of Foundation); NP-8 (President); NP-7 (K.J. Luke Foundation); OV-1 (Commission member — exact title/dates to be verified against Commission records before publication)
...
Key edges: JD-1 (Commission member — exact title TBV), JD-2 (Commission member — exact title TBV); OV-2 (90-day rule); JD-5 (complaint filed re: Dec 2 incident — Issue 4)
...
| JD-1 | OV-1 | governance | Commission member (exact title TBV) | — | Commission records |
...
| JD-2 | OV-1 | governance | Commission member (exact title TBV) | — | Commission records |
